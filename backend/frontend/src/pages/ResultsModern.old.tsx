...
// Helper: Bereken progress binnen tier range
...
// vELO Badge - Matrix style met rank circle + rating + PROGRESSIE BALK + trend NAAST
                ...
                {event.total_riders && (
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-gray-700">{event.total_riders}</span>
                    </div>
                    {/* Team riders compact naast totaal */}
                    <div className="flex items-center gap-1 text-orange-600">
                      <UserCheck2 className="w-4 h-4" />
                      <span className="font-semibold">{event.results.length}</span>
                    </div>
                  </div>
                )}
              </div>
