-- Seed Data V2: Test Results voor Results Dashboard
-- Run dit in Supabase SQL Editor NA de migration (SUPABASE_ADD_RESULTS_COLUMNS.sql)

-- STAP 1: Verwijder oude test data (event IDs 5000001-5000005)
DELETE FROM zwift_api_race_results 
WHERE event_id::text LIKE '5000%';

-- STAP 2: Insert test results met power curves en vELO data
