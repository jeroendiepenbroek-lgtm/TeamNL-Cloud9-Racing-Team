...
async function addFavoriteRider(zwiftId, priority = 1) {
    try {
...
async function addFavoritesFromFile(filePath, priority = 2) {
...
async function addFavoritesFromArgs(zwiftIds, priority = 1) {
...
main();
//# sourceMappingURL=add-favorites.js.map