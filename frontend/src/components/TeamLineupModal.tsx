...
export default function TeamLineupModal({ teamId, onClose, isDragging = false }: TeamLineupModalProps) {
  ...
  if (isLoading || !teamData) {
    return (
      <aside ref={setNodeRef} className="fixed md:sticky right-0 top-0 md:top-[73px] w-full sm:w-96 lg:w-[550px] xl:w-[600px] h-screen md:h-[calc(100vh-73px)] border-l border-slate-700/50 bg-slate-800/95 backdrop-blur-xl z-40 shadow-2xl shadow-black/50 flex items-center justify-center">
  ...
  return (
    <aside 
      ref={setNodeRef}
      className={`fixed md:sticky right-0 top-0 md:top-[73px] w-full sm:w-96 lg:w-[550px] xl:w-[600px] h-screen md:h-[calc(100vh-73px)] border-l-4 bg-slate-800/95 backdrop-blur-xl z-40 shadow-2xl shadow-black/50 flex flex-col transition-all duration-300 ${
