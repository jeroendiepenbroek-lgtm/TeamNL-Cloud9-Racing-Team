-- ============================================================================
-- FORCE CLEAN DEPLOYMENT - TeamNL Cloud9 Racing
-- ============================================================================
-- Dit script verwijdert ALLES en deploy daarna het complete MVP schema
-- Run dit in Supabase SQL Editor in één keer
-- ============================================================================

-- ============================================================================
-- STAP 1: NUCLEAR CLEANUP - Drop ALLES in public schema
-- ============================================================================

-- Drop ALL policies, views, triggers, functions, tables in één keer
DO $$ 
DECLARE
    r RECORD;
BEGIN
    ...
    -- Drop all tables (CASCADE drops indexes, constraints, triggers automatically)
